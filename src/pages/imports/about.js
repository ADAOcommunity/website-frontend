      ...
      <div className="section__horizontal">
        ...
        <div className="section__text">
          ...
          <p>
            ...
            process, but we believe in the power of what we can accomplish if we
            work together.
          </p>
          ...
          <p>
            ...
            while staying connected globally, any time, any day. This allows for
            open, fair ways to participate and be heard that suit your group's
            needs, whenever and wherever. The decentralized communities you form
            using the tools that we build will ultimately be the greatest
