  ...
  return (
    <div className="footer">
      ...
      <div className="footer__section">
        ...
        <ul className="social vr">
          <li className="social__card discord">
            <a
              href="https://discord.gg/pYwXkygtBa"
          ...
          <li className="social__card twitter">
            <a
          ...
          <li className="social__card medium">
            <a
          ...
          <li className="social__card youtube">
            <a
              href="https://www.youtube.com/channel/UCUjqr4Cn_COlSUm7pa0O97g"
              rel="noopener noreferrer"
              target="_blank"
            >
      ...
      <img className="graphic" src={wave} alt="" />
    </div>
  )
}
