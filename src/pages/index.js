        ...
        <div class="section__text">
          ...
          <div class="accordion">
            <div class="accordion__tab">
              ...
              <label class="tab-label" for="chck1">What is $ADAO?
              ...
              <div class="tab-content">
                ...
                $ADAO Policy id: <span class="force-break">5b01968867e13432afaa2f814e1d15e332d6cd0aa77e350972b0967d</span>
              </div>
            </div>
            <div class="accordion__tab">
              <input type="checkbox" id="chck2" />
              <label class="tab-label" for="chck2">ADAO Treasury - 77%
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M118.6 105.4l128 127.1C252.9 239.6 256 247.8 256 255.1s-3.125 16.38-9.375 22.63l-128 127.1c-9.156 9.156-22.91 11.9-34.88 6.943S64 396.9 64 383.1V128c0-12.94 7.781-24.62 19.75-29.58S109.5 96.23 118.6 105.4z"/></svg>
              </label>
              <div class="tab-content">
            ...
            <div class="accordion__tab">
              ...
              <label class="tab-label" for="chck3">Groundwork Bounty Program - 18.4%
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M118.6 105.4l128 127.1C252.9 239.6 256 247.8 256 255.1s-3.125 16.38-9.375 22.63l-128 127.1c-9.156 9.156-22.91 11.9-34.88 6.943S64 396.9 64 383.1V128c0-12.94 7.781-24.62 19.75-29.58S109.5 96.23 118.6 105.4z"/></svg>
              </label>
              <div class="tab-content">
            ...
            <div class="accordion__tab">
              ...
              <label class="tab-label" for="chck4">Initial Core Contributors - 2.6%
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M118.6 105.4l128 127.1C252.9 239.6 256 247.8 256 255.1s-3.125 16.38-9.375 22.63l-128 127.1c-9.156 9.156-22.91 11.9-34.88 6.943S64 396.9 64 383.1V128c0-12.94 7.781-24.62 19.75-29.58S109.5 96.23 118.6 105.4z"/></svg>
              </label>
              <div class="tab-content">
            ...
            <div class="accordion__tab">
              ...
              <label class="tab-label" for="chck5">Blockchain-wide Airdrop - 1.5%
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M118.6 105.4l128 127.1C252.9 239.6 256 247.8 256 255.1s-3.125 16.38-9.375 22.63l-128 127.1c-9.156 9.156-22.91 11.9-34.88 6.943S64 396.9 64 383.1V128c0-12.94 7.781-24.62 19.75-29.58S109.5 96.23 118.6 105.4z"/></svg>
              </label>
              <div class="tab-content">
            ...
            <div class="accordion__tab">
              ...
              <label class="tab-label" for="chck6">Active Community Member Airdrop - 0.5%
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M118.6 105.4l128 127.1C252.9 239.6 256 247.8 256 255.1s-3.125 16.38-9.375 22.63l-128 127.1c-9.156 9.156-22.91 11.9-34.88 6.943S64 396.9 64 383.1V128c0-12.94 7.781-24.62 19.75-29.58S109.5 96.23 118.6 105.4z"/></svg>
              </label>
              <div class="tab-content">
    ...
    <div class="footer__section">
      ...
      <ul class="social vr">
        <li class="social__card discord">
          <a href="https://discord.gg/RmutweNfdE">
        ...
        <li class="social__card twitter">
          <a href="https://twitter.com/ADAOcommunity">
        ...
        <li class="social__card pinterest">
          <a href="https://medium.com/@ADAOcommunity">
        ...
        <li class="social__card youtube">
          <a href="https://www.youtube.com/channel/UCUjqr4Cn_COlSUm7pa0O97g">
